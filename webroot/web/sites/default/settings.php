 ...
 * @endcode
 */
$settings['hash_salt'] = '_HxngRrCI6Zdk-2YT82o1V31jWnj0yU8jNi4vvkxxm_8B41wK-8jA_1bKmyZU57rDQwer3PYhQ';
...
$settings['trusted_host_patterns'] = [
	'^arcdev\.cityofparramatta\.nsw\.gov\.au$',
	'^arctest\.cityofparramatta\.nsw\.gov\.au$',
	'^arcprod\.cityofparramatta\.nsw\.gov\.au$',
	'^arc\.cityofparramatta\.nsw\.gov\.au$',
    '^arcdev\.parracity\.nsw\.gov\.au$',
    '^arctest\.parracity\.nsw\.gov\.au$',
